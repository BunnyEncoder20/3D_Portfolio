...
const DemoComputer = (props) => {
    ...
    // video texture for demo
    const texture = props.texture ? useVideoTexture(props.texture) : useVideoTexture('/textures/project/project1.mp4')
    ...
    // fliping the video texture (cause it's rendering upside down by defualt)
    useEffect(() => {
      if(texture){
        texture.flipY = false
      }
