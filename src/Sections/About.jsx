                    ...
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext">
                                I’m very flexible with almost all time zone communications & locations
                            </p>
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I love solving problems abd building things through code. Coding isn't just my profession, it is my Passion.</p>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">varun.verma2024@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
